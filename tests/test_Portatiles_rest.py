...
def test_rest_numero_portatiles(cliente_test):
    respuesta = app.get('/portatiles/numeroPortatilesEnBD')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
    elif (respuesta.status_code == 413):
        assert (respuesta.status_code == 413)
...
def est_rest_agregar_portatil_y_seleccionar_version_corta(cliente_test):
    #Agregar portatil
    respuesta = app.post('/portatiles/agregarPortatil/msi/gl62/333X/600')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
...
def test_rest_agregar_portatil_y_seleccionar_version_larga(cliente_test):
    #Agregar portatil
    respuesta = app.post('/agregarPortatil/msi/gl62/333X/600/Muy%20bueno/15/i7/GB%20DDR4/1gb/GTX/2H/Linux')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
    elif (respuesta.status_code == 413):
        assert (respuesta.status_code == 413)
...
def test_rest_modificar_portatil_solo_precio_y_seleccionar(cliente_test):
    ...
    respuesta = cliente.post('/portatiles/agregarPortatil/msi/gl62/333X/600')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        indice = json_util.loads(respuesta.data)
    elif (respuesta.status_code == 413):
...
def test_rest_buscar_portatil_dnivendedor(cliente_test):
    respuesta = app.get('/portatiles/verPortatilesEnVentaDeUsuario/666X')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
    ...
    respuesta = cliente.post('/portatiles/agregarPortatil/lg/gram/666X/1100')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
    ...
    respuesta = cliente.get('/portatiles/verPortatilesEnBDDeUsuario/666X')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
...
def test_rest_buscar_portatil_precio(cliente_test):
    #Agregar portatil
    respuesta = cliente.post('/portatiles/agregarPortatil/msi/gl62/333X/100000')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        indice1 = json_util.loads(respuesta.data)
    elif (respuesta.status_code == 413):
        ...
        assert (respuesta.status_code == 412)
    #Agregar otro portatil
    respuesta = cliente.post('/portatiles/agregarPortatil/lg/gram/333X/100000')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        indice2 = json_util.loads(respuesta.data)
    elif (respuesta.status_code == 413):
    ...
    #Agregan a lista para comparar
    lista = [portatil1, portatil2]
    respuesta = cliente.get('/portatiles/buscarPortatilPorPrecio/99999/120000')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        assert json.loads(respuesta.data) == lista
    elif (respuesta.status_code == 413):
...
def test_rest_buscar_portatil_modelo_marca(cliente_test):
    #Agregar portatil
    respuesta = cliente.post('/portatiles/agregarPortatil/marca_especial/modelo_especial/333X/600')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        indice1 = json_util.loads(respuesta.data)
    elif (respuesta.status_code == 413):
        ...
        assert (respuesta.status_code == 412)
    #Agregar otro portatil
    respuesta = cliente.post('/portatiles/agregarPortatil/marca_especial/modelo_especial/333X/1100')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        indice2 = json_util.loads(respuesta.data)
    elif (respuesta.status_code == 413):
    ...
    #Agregan a lista para comparar
    lista = [portatil1, portatil2]
    respuesta = cliente.get('/portatiles/buscarPortatilPorModeloMarca/modelo_especial/marca_especial')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        assert json.loads(respuesta.data) == lista
    elif (respuesta.status_code == 413):
...
def test_rest_comparar_portatiles(cliente_test):
    ...
    #Agregar portatil
    respuesta = cliente.post('/portatiles/agregarPortatil/marca_especial_com/modelo_especial_com/333X/6000')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        indice1 = json_util.loads(respuesta.data)
    elif (respuesta.status_code == 413):
        ...
        assert (respuesta.status_code == 412)
    #Agregar otro portatil
    respuesta = cliente.post('/portatiles/agregarPortatil/marca_especial_com/modelo_especial_com/333X/1100')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        indice2 = json_util.loads(respuesta.data)
    elif (respuesta.status_code == 413):
    ...
    #Agregan a lista para comparar
    lista = [portatil1, portatil2]
    respuesta = cliente.get('/portatiles/buscarPortatilPorModeloMarca/modelo_especial_com/marca_especial_com')
    if (respuesta.status_code == 200):
        assert (respuesta.status_code == 200 and respuesta.headers["Content-Type"] == "application/json")
        assert json.loads(respuesta.data) == lista
    elif (respuesta.status_code == 413):
...
def test_limpiar_bd_y_comprobar_vacia(cliente_test):
    ...
    print(lista1)
    respuesta = cliente.get('/portatiles/verPortatilesEnBDDeUsuario/333X')
